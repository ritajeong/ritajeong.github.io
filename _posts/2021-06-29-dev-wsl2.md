...
<img src="Cap 2021-06-29 20-11-37-139.jpg" width="80%" height="80%">    

## terminal을 관리자 권한으로 열기
<img src="Cap 2021-06-29 20-12-30-849.jpg" width="80%" height="80%">    
...
<img src="Cap 2021-06-29 20-15-07-811.jpg" width="80%" height="80%">    

## Ubuntu 초기설정
상단의 사전작업에서 설치한 우분투를 실행합니다.  
UNIX 상에서 사용할 username을 타이핑하고, 차례로 password 설정도 해주세요.  
<img src="Cap 2021-06-29 21-45-04-877.jpg" width="80%" height="80%">    
